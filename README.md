...
Оставил хромдрайвер для винды в папке и для убунту не в папке.
...
6. Запустить сам файл main.py, если в консоли видите что клик был сделан и идет ожидание карточки - все сделали правильно. 
